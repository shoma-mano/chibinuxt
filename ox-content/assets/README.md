# Ox Content Logo Assets

This directory contains logo assets for Ox Content.
...
- Ensure adequate contrast on light backgrounds
- Use `logo-icon.svg` for sizes below 64px
- Prefer `logo-dark.svg` for transparent overlays
