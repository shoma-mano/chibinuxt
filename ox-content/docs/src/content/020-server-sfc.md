...
Full Code is available at [2-server-sfc](https://github.com/shoma-mano/chibinuxt/tree/main/impls/2-server-sfc)
...
[`App.vue`](https://github.com/shoma-mano/chibinuxt/blob/main/impls/2-server-sfc/src/App.vue)
...
[`entry.server.ts`](https://github.com/shoma-mano/chibinuxt/blob/main/impls/2-server-sfc/src/entry.server.ts)
...
[`vite.ts`](https://github.com/shoma-mano/chibinuxt/blob/main/impls/2-server-sfc/src/vite.ts)
...
[`render.ts`](https://github.com/shoma-mano/chibinuxt/blob/main/impls/2-server-sfc/src/render.ts)
...
[`main.ts`](https://github.com/shoma-mano/chibinuxt/blob/main/impls/2-server-sfc/src/main.ts)
