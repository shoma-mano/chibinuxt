import { resolveComponent, withCtx, createTextVNode, useSSRContext, onUnmounted, onDeactivated, onActivated, getCurrentInstance, inject, computed, unref, watchEffect, defineComponent, reactive, h, provide, ref, watch, shallowRef, nextTick, shallowReactive, createSSRApp } from "vue";
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_RouterLink, { to: "/hello" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` Go to Hello `);
      } else {
        return [
          createTextVNode(" Go to Hello ")
        ];
      }
    }),
    _: 1
  ...
  _push(ssrRenderComponent(_component_RouterLink, { to: "/world" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` Go to World `);
      } else {
        return [
          createTextVNode(" Go to World ")
        ];
      }
    }),
    _: 1
...
const Hello = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<h1${ssrRenderAttrs(_attrs)}>World!</h1>`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/world.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const World = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
const createRouter = () => {
  const routes = [
    {
      path: "/hello",
  ...
  const history2 = true ? createMemoryHistory() : createWebHistory();
